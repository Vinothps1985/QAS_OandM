...
@author:Anusha MG
@description:Verify the optimization of service appointment using a Landscaping case
@case @positive @regression @optimizeme
@dataFile:resources/testdata/Cases/Optimization of service appointment using Landscaping case.csv
Scenario: Optimization of service appointment using Landscaping case
   ...
   And add 4 business days to current date and store it into "nextBusinessDay" in format "M/d/yyyy"
